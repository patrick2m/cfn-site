    ...
    return (
        <main id="main-content">
            ...
            <p className="main-description">
                ...
                Somos uma Casa cheia de tradição e boas histórias! No mercado desde 1957, seu Isaac, 
                fundador e presidente do grupo Casa das Fechaduras de Niterói, deu início á loja que conhecemos hoje! 
